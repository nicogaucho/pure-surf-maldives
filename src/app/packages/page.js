    ...
    <>
      <div className={style.centerheropackage + " px-4 py-5 text-center"}>
        <Image 
          ...
          width="300"
        />
        <h1 className={`display-1 text-white my-5 ${tropicalOrange.className}`}>All Packages</h1>
      </div>
      ...
      <div id="explore" className="container">
        <div className="row mb-5">
          <div className="col-12 text-center">
            <h2 className={`${tropicalOrange.className} display-4 tx-main-color`}>Explore more about our packages</h2>
          </div>      
        </div>
        <div className="row mb-5">
              ...
              <div className="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabIndex="0">
                <div className="container p-5">
                  <div className="row mb-5 justify-content-around align-items-center">
                    ...
                    <div className="col-12 col-md-5 mb-3">
                      <p className={`${tropicalOrange.className} h1`}>First step</p>
              ...
              <div className="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabIndex="0">
                <div className="container p-5">
                  <div className="row mb-5 justify-content-around align-items-center">
                    ...
                    <div className="col-12 col-md-5 mb-3">
                      <p className={`${tropicalOrange.className} h1`}>Improvement</p>
                      <p className="lead tx-main-color">Overview</p>
              ...
              <div className="tab-pane fade" id="contact-tab-pane" role="tabpanel" aria-labelledby="contact-tab" tabIndex="0">
                <div className="container p-5">
                  <div className="row mb-5 justify-content-around align-items-center">
                    ...
                    <div className="col-12 col-md-5 mb-3">
                      <p className={`${tropicalOrange.className} h1`}>Free spirit</p>
                      <p className="lead tx-main-color">Overview</p>
