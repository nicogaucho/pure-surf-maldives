      ...
      <div className="container my-5">
              ...
              <div className="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabIndex="0">
                <div className="container p-5">
                  <div className="row mb-5 justify-content-around align-items-center">
                    ...
                    <div className="col-12 col-md-5 mb-3">
                      <p className={`${tropicalOrange.className} h1 tx-main-color`}>Standard Island view</p>
              ...
              <div className="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabIndex="0">
                <div className="container p-5">
                  <div className="row mb-5 justify-content-around align-items-center">
                    ...
                    <div className="col-12 col-md-5 mb-3">
                      <p className={`${tropicalOrange.className} h1 tx-main-color`}>Standard Ocean View </p>
              ...
              <div className="tab-pane fade" id="contact-tab-pane" role="tabpanel" aria-labelledby="contact-tab" tabIndex="0">
                <div className="container p-5">
                  <div className="row mb-5 justify-content-around align-items-center">
                    ...
                    <div className="col-12 col-md-5 mb-3">
                      <p className={`${tropicalOrange.className} h1 tx-main-color`}>Deluxe Island Viex</p>
              ...
              <div className="tab-pane fade" id="only-tab-pane" role="tabpanel" aria-labelledby="only-tab" tabIndex="0">
                <div className="container p-5">
                  <div className="row mb-5 justify-content-around align-items-center">
                    ...
                    <div className="col-12 col-md-5 mb-3">
                      <p className={`${tropicalOrange.className} h1 tx-main-color`}>Deluxe Ocean View</p>
        ...
        <div className="row mb-3 align-items-center justify-content-around">
          <div className="col-12 col-md-5 mb-5">
            <Image src={foodSectionURL} alt="food selection Maldives" className="img-fluid" />
          </div>
          <div className="col-12 col-md-5 mb-5 order-md-first">
            <p className="tx-main-color text-uppercase">FOOD</p>
            <p className={`${tropicalOrange.className} h1`}>Experience local food</p>
        ...
        <div className="row mb-3 align-items-center justify-content-around">
          <div className="col-12 col-md-5 mb-5">
            <Image src={lifeMaldivesURL} alt="Maldives life" className="img-fluid" />
          </div>
          <div className="col-12 col-md-5 mb-5">
            <p className="tx-main-color text-uppercase">YOUR DAY</p>
            <p className={`${tropicalOrange.className} h1`}>LIVE THE SURF LIFESTYLE</p>
        ...
        <div className="container">
          ...
          <div className="row my-5">
            ...
            <div className="col-12 col-md-4 mb-5 text-center">
              <div className="mb-3">
                <Image src={pureSurfLogoWhite} alt="logo pure surf" width={150} />
